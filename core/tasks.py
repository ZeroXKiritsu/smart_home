...
headers = {
    'Authorization': settings.SMART_HOME_ACCESS_TOKEN
}
...
def smart_home_manager():
    ...
    bedroom_target_temp = Settings.objects.get(controller_name='bedroom_target_temperature').value
    bedroom_temp = data['bedroom_temperature']

    hot_water_temp = data['boiler_temperature']
    hot_water_target_temp = Settings.objects.get(controller_name='hot_water_target_temperature').value
